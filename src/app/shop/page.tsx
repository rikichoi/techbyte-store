...
export default function Shop() {
  ...
  return (
    <main className="h-full font-poppins pt-[18vh]">
      ...
      >
        <h2 className="xs:text-3xl text-4xl">Products</h2>
        ...
        <div className="grid xs:gap-2 grid-cols-2 xs:grid-cols-1">
          ...
          <div className="flex flex-row xs:justify-start justify-end items-center">
            <h4 className="pr-2 text-sm font-light">Sort By:</h4>
            <select
              id="sortOptions"
              defaultValue={"Newest"}
              className="text-base xs:text-xs sm:text-xs bg-white p-1 border-2 hover:cursor-pointer rounded-lg"
              name="sortOptions"
            >
